...
[_QWERTY] = LAYOUT(
  ...
  CK_LCTRL, KC_Z, KC_X,   KC_C,     KC_V,    KC_B, _SOUND_SWITCH,      TD(PG_UP),  KC_N, KC_M,      KC_COMM, KC_DOT, KC_SLSH, CK_RCTRL,
...
[_GAME] = LAYOUT(
   ...
   KC_LSFT, KC_Z, KC_X,   KC_C,     KC_V,    KC_B, TD(PG_DN),      TD(PG_UP),  KC_N, KC_M,      KC_COMM, KC_DOT, KC_SLSH, CK_RCTRL,
            KC_LGUI, TT(_NUM),   KC_LCTL, KC_LALT, KC_SPC,      CK_RENT, CK_RALT, TT(_FUNC), KC_BSPC, TD(MEDIA_SCROLL)
),
};
